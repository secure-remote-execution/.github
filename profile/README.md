...
|---|---|---|---|
| **Lab 3** | HTTP público sin autenticación — reconocimiento, telemetría y hardening básico | ✅ | [Ver informe](https://github.com/secure-remote-execution/secure-frontend/blob/main/docs/labs/FDSI%20Lab3.pdf) |
